...
//        System.out.println(encryptString("1111", "12345"));
//        System.out.println(convertByteToHex(encryptMode("bio@bank".getBytes(), "123456".getBytes())));
//        System.out.println(new String(decryptMode("bio@bank".getBytes(),encryptMode("bio@bank".getBytes(), "123456".getBytes()))));
//    }
}
